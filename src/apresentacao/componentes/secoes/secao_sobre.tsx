                ...
                {!erroImagem ? (
                  <div className="relative w-full h-full">
                    ...
                    {/* Imagem real do perfil */}
                      ...
                      className={`relative w-full h-full object-cover transition-opacity duration-500 ${imagemCarregada ? "opacity-100" : "opacity-0"
                        }`}
                      style={{
